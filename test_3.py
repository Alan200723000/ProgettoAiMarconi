    ...
    def mostra_login():
        ...
        def esegui_login(e):
            ...
            if utente in UTENTI and UTENTI[utente]["password"] == pwd:
                ruolo = UTENTI[utente]["ruolo"]
                mostra_workspace(utente, ruolo)
            else:
                ...
                content=ft.Column(
                    [
                        ...
                        ft.Container(
                            content=ft.Column(
                                [
                                    ft.Text("Account di prova", color="#475569", size=11, weight=ft.FontWeight.BOLD),
                                    ft.Text("👨‍🎓 studente1  /  prova1", color="#334155", size=12, italic=True),
                                    ft.Text("👨‍🏫 docente1   /  prova1", color="#334155", size=12, italic=True),
                                ],
